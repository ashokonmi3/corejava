...
// System.out.println(str2.substring(18)); // com
 ...
 * a character of a String. 4)Write a java program to compare two strings
 * lexicographically. 5) Write a Java program to concatenate a given string to
 * the end of another string. 6) Write a Java program to test if a given string
 * contains the specified sequence of char values. 7) Write a java program to
 * get the length of a given string. 8)Write a Java program to convert all the
 * characters in a string to lowercase. 9) Write a Java program to convert all
 * the characters in a string to uppercase 10) Write a program to reverse a
 * string
 */
